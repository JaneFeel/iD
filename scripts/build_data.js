...
function buildData() {
  ...
  let tasks = [
    ...
    downloadExternalData(`${nsiUrl}dist/dissolved.min.json`, 'dist/data/nsi/dissolved.min.json'),
    downloadExternalData(`${nsiUrl}dist/featureCollection.min.json`, 'dist/data/nsi/featureCollection.min.json'),
    downloadExternalData(`${nsiUrl}dist/genericWords.min.json`, 'dist/data/nsi/genericWords.min.json'),
    downloadExternalData(`${nsiUrl}dist/presets/nsi-id-presets.min.json`, 'dist/data/nsi/nsi-id-presets.min.json'),
    downloadExternalData(`${nsiUrl}dist/replacements.min.json`, 'dist/data/nsi/replacements.min.json'),
    downloadExternalData(`${nsiUrl}dist/trees.min.json`, 'dist/data/nsi/trees.min.json'),
